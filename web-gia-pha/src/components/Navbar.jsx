...
import {
    selectPendingCount,
    fetchRequests,
} from "../store/slices/editRequestsSlice";
...
const Navbar = () => {
    ...
    const activeFamilyId = currentFamilyId
        ? Number(currentFamilyId)
        : primaryFamilyId ||
          (userFamilies?.length > 0 ? userFamilies[0].id : null);
            ...
            ? [
                      ...
                      items: [
                          {
                              ...
                              path: `/${currentFamilyId}/members`,
                          },
                          {
                              name: "Sơ đồ cây",
                              path: `/${currentFamilyId}/family-tree`,
                          },
                          {
                              name:
                                  pendingRequestsCount > 0
                                      ? `Yêu cầu chỉnh sửa (${pendingRequestsCount})`
                                      : "Yêu cầu chỉnh sửa",
                  ...
                  },
                  {
                      ...
                      items: [
                          {
                              name: "Bài viết",
                              path: `/${currentFamilyId}/posts`,
                          },
                          {
                              name: "Sự kiện",
                              path: `/${currentFamilyId}/events`,
                          },
                          {
                              name: "Thư viện ảnh",
                              path: `/${currentFamilyId}/gallery`,
                          },
                      ],
                  },
              ]
            ...
            <div className="container nav-container">
                    ...
                    {userFamilies?.length > 1 ? (
                        ...
                        >
                            ...
                            >
                                ...
                                <ChevronDown
                                    size={16}
                                    className={`chevron ${openDropdown === "switcher" ? "open" : ""}`}
                                    style={{ marginLeft: "4px", flexShrink: 0 }}
                                />
                            </button>

                            <div
                                className={`dropdown-menu ${openDropdown === "switcher" ? "show" : ""}`}
                                style={{
                                    left: 0,
                                    right: "auto",
                                    minWidth: "200px",
                ...
                >
                    ...
                    {navGroups.map((group, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <ChevronDown
                                    size={16}
                                    className={`chevron ${openDropdown === index ? "open" : ""}`}
                                />
                            </button>
                    ...
                    <button
                        ...
                        onClick={() =>
                            handleNavClick(`/${currentFamilyId}/kinship-lookup`)
                        }
                    >
                        Tra cứu xưng hô
                    </button>
                ...
                >
                    <button
                        ...
                        onClick={() =>
                            navigate(`/${currentFamilyId}/edit-requests`)
                        }
                    >
                        <Bell size={20} />
                        {pendingRequestsCount > 0 && (
